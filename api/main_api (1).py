...
def search(
    ...
    return search_articles(
        q=q, limit=limit, category=category,
        topic=topic, days=days, source_id=source_id,
    )
...
def create_source(
    ...
    subcategory: Optional[str] = None, interval_min: int = 30,
):
...
def edit_source(
    source_id: str, name: Optional[str] = None, url: Optional[str] = None,
