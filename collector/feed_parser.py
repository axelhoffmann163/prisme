...
CATEGORIES = {
    ...
    "Économie": [
        ...
        "investissement", "emploi", "chômage", "salaire", "industrie",
        "commerce", "exportation", "importation", "startup", "faillite",
        "bénéfice", "chiffre d'affaires", "taux", "euro", "fiscal", "impôt",
        "taxe", "déficit", "recession", "relance", "pme", "crise économique",
    ],
    "Social": [
        ...
        "licenciement", "chômage partiel", "dialogue social", "cgt", "cfdt",
        "fo", "patronat", "medef", "conditions de travail",
    ],
    "Justice": [
    ...
    "International": [
        ...
        "traité", "immigration", "réfugiés", "frontière", "otan",
    ...
    "Santé": [
        ...
        "chirurgie", "urgences", "soin", "patient", "infirmier", "nhôpital",
    ...
    "Environnement": [
        ...
        "cop", "accord de paris", "transition", "vert", "électrique",
    ...
    "Science & Tech": [
        ...
        "hacker", "hack", "startup tech", "5g", "quantum", "génomique",
        "biotechnologie", "médecine", "découverte", "laboratoire",
        "smartphone", "réseaux sociaux", "meta", "google", "apple",
...
def parse_feed(result, source_id, feed_id, category, tags):
    ...
    for entry in parsed.entries:
        try:
            ...
            thematic_category = classify_article(title, summary or "")
            ...
            articles.append(ArticleRecord(
                ...
                category=thematic_category or category,
                tags=all_tags[:20],
                language="fr",
