...
SOURCES = [
    ...
    {"id": "liberation", "name": "Libération", "category": "PQN", "subcategory": "Généraliste", "url": "https://www.liberation.fr/arc/outboundfeeds/rss/?outputType=xml", "interval": 30, "active": True, "tags": ["généraliste"], "extra_feeds": {}},
    ...
    {"id": "la_croix", "name": "La Croix", "category": "PQN", "subcategory": "Généraliste", "url": "https://www.la-croix.com/RSS", "interval": 30, "active": True, "tags": ["généraliste"], "extra_feeds": {}},
    ...
    {"id": "le_point", "name": "Le Point", "category": "PQN", "subcategory": "Généraliste", "url": "https://www.lepoint.fr/24h-infos/rss.xml", "interval": 30, "active": True, "tags": ["généraliste"], "extra_feeds": {}},
    ...
    {"id": "valeurs_actuelles", "name": "Valeurs Actuelles", "category": "PQN", "subcategory": "Généraliste", "url": "https://www.valeursactuelles.com/feed", "interval": 30, "active": True, "tags": ["politique"], "extra_feeds": {}},
    {"id": "le_jdd", "name": "Le JDD", "category": "PQN", "subcategory": "Généraliste", "url": "https://www.lejdd.fr/rss.xml", "interval": 30, "active": True, "tags": ["généraliste"], "extra_feeds": {}},
    {"id": "alternatives_eco", "name": "Alternatives Économiques", "category": "PQN", "subcategory": "Économie", "url": "https://www.alternatives-economiques.fr/rss.xml", "interval": 360, "active": True, "tags": ["économie"], "extra_feeds": {}},
    {"id": "l_usine_nouvelle", "name": "L'Usine Nouvelle", "category": "PQN", "subcategory": "Industrie", "url": "https://www.usinenouvelle.com/rss/all", "interval": 60, "active": True, "tags": ["industrie", "économie"], "extra_feeds": {}},
    {"id": "boursier_com", "name": "Boursier.com", "category": "PQN", "subcategory": "Finance", "url": "https://www.boursier.com/rss/actualites.rss", "interval": 15, "active": True, "tags": ["bourse", "finance"], "extra_feeds": {}},
    {"id": "silicon_fr", "name": "Silicon.fr", "category": "PQN", "subcategory": "Tech", "url": "https://www.silicon.fr/feed", "interval": 60, "active": True, "tags": ["numérique", "tech"], "extra_feeds": {}},
    {"id": "gazette_communes", "name": "Gazette des Communes", "category": "PQN", "subcategory": "Collectivités", "url": "https://www.lagazettedescommunes.com/feed/", "interval": 60, "active": True, "tags": ["collectivités", "politique"], "extra_feeds": {}},
    {"id": "le_canard_enchaine", "name": "Le Canard Enchaîné", "category": "PQN", "subcategory": "Satirique", "url": "https://news.google.com/rss/search?q=source:lecanardenchaine.fr&hl=fr&gl=FR&ceid=FR:fr", "interval": 360, "active": True, "tags": ["politique", "investigation"], "extra_feeds": {}},
    {"id": "actu_fr", "name": "Actu.fr", "category": "Natif", "subcategory": "Local", "url": "https://actu.fr/rss/france.rss", "interval": 30, "active": True, "tags": ["local", "régional"], "extra_feeds": {}},
    ...
    {"id": "le_telegramme", "name": "Le Télégramme", "category": "PQR", "subcategory": "Grand Ouest", "url": "https://www.letelegramme.fr/rss.xml", "interval": 60, "active": True, "tags": ["bretagne"], "extra_feeds": {}},
    ...
    {"id": "la_nouvelle_republique", "name": "La Nouvelle République", "category": "PQR", "subcategory": "Centre-Ouest", "url": "https://www.lanouvellerepublique.fr/rss.xml", "interval": 60, "active": True, "tags": ["tours", "vienne"], "extra_feeds": {}},
    ...
    {"id": "courrier_picard", "name": "Courrier Picard", "category": "PQR", "subcategory": "Hauts-de-France", "url": "https://www.courrier-picard.fr/rss", "interval": 60, "active": True, "tags": ["picardie", "hauts-de-france"], "extra_feeds": {}},
    {"id": "republicain_lorrain", "name": "Républicain Lorrain", "category": "PQR", "subcategory": "Grand Est", "url": "https://www.republicain-lorrain.fr/rss", "interval": 60, "active": True, "tags": ["lorraine", "grand-est"], "extra_feeds": {}},
    {"id": "vosges_matin", "name": "Vosges Matin", "category": "PQR", "subcategory": "Grand Est", "url": "https://www.vosgesmatin.fr/rss", "interval": 60, "active": True, "tags": ["vosges", "grand-est"], "extra_feeds": {}},
    {"id": "l_union_ardennais", "name": "L'Union / L'Ardennais", "category": "PQR", "subcategory": "Grand Est", "url": "https://www.lunion.fr/rss", "interval": 60, "active": True, "tags": ["reims", "ardennes"], "extra_feeds": {}},
    {"id": "paris_normandie", "name": "Paris-Normandie", "category": "PQR", "subcategory": "Normandie", "url": "https://www.paris-normandie.fr/rss", "interval": 60, "active": True, "tags": ["normandie", "rouen"], "extra_feeds": {}},
    {"id": "la_manche_libre", "name": "La Manche Libre", "category": "PQR", "subcategory": "Normandie", "url": "https://news.google.com/rss/search?q=source:lamanchelibre.fr&hl=fr&gl=FR&ceid=FR:fr", "interval": 60, "active": True, "tags": ["normandie", "manche"], "extra_feeds": {}},
    {"id": "charente_libre", "name": "Charente Libre", "category": "PQR", "subcategory": "Nouvelle-Aquitaine", "url": "https://www.charentelibre.fr/rss.xml", "interval": 60, "active": True, "tags": ["charente", "angoulême"], "extra_feeds": {}},
    {"id": "var_matin", "name": "Var Matin", "category": "PQR", "subcategory": "Provence-Alpes-Côte d'Azur", "url": "https://www.varmatin.com/rss.xml", "interval": 60, "active": True, "tags": ["var", "toulon"], "extra_feeds": {}},
    {"id": "corse_matin", "name": "Corse-Matin", "category": "PQR", "subcategory": "Corse", "url": "https://news.google.com/rss/search?q=source:corsematin.com&hl=fr&gl=FR&ceid=FR:fr", "interval": 60, "active": True, "tags": ["corse"], "extra_feeds": {}},
    {"id": "le_berry_republicain", "name": "Le Berry Républicain", "category": "PQR", "subcategory": "Centre-Val de Loire", "url": "https://news.google.com/rss/search?q=source:leberry.fr&hl=fr&gl=FR&ceid=FR:fr", "interval": 60, "active": True, "tags": ["cher", "bourges"], "extra_feeds": {}},
    {"id": "la_republique_du_centre", "name": "La République du Centre", "category": "PQR", "subcategory": "Centre-Val de Loire", "url": "https://news.google.com/rss/search?q=source:larep.fr&hl=fr&gl=FR&ceid=FR:fr", "interval": 60, "active": True, "tags": ["loiret", "orléans"], "extra_feeds": {}},
    {"id": "le_journal_du_centre", "name": "Le Journal du Centre", "category": "PQR", "subcategory": "Centre-Val de Loire", "url": "https://news.google.com/rss/search?q=source:lejdc.fr&hl=fr&gl=FR&ceid=FR:fr", "interval": 60, "active": True, "tags": ["nièvre", "centre"], "extra_feeds": {}},
    {"id": "l_yonne_republicaine", "name": "L'Yonne Républicaine", "category": "PQR", "subcategory": "Bourgogne-Franche-Comté", "url": "https://news.google.com/rss/search?q=source:lyonne.fr&hl=fr&gl=FR&ceid=FR:fr", "interval": 60, "active": True, "tags": ["yonne", "auxerre"], "extra_feeds": {}},
    {"id": "le_populaire_du_centre", "name": "Le Populaire du Centre", "category": "PQR", "subcategory": "Nouvelle-Aquitaine", "url": "https://news.google.com/rss/search?q=source:lepopulaire.fr&hl=fr&gl=FR&ceid=FR:fr", "interval": 60, "active": True, "tags": ["limousin", "limoges"], "extra_feeds": {}},
    {"id": "l_echo_republicain", "name": "L'Écho Républicain", "category": "PQR", "subcategory": "Centre-Val de Loire", "url": "https://news.google.com/rss/search?q=source:lechorepublicain.fr&hl=fr&gl=FR&ceid=FR:fr", "interval": 60, "active": True, "tags": ["eure-et-loir", "chartres"], "extra_feeds": {}},
    {"id": "journal_saone_et_loire", "name": "Journal Saône-et-Loire", "category": "PQR", "subcategory": "Bourgogne-Franche-Comté", "url": "https://news.google.com/rss/search?q=source:lejsl.com&hl=fr&gl=FR&ceid=FR:fr", "interval": 60, "active": True, "tags": ["bourgogne", "mâcon"], "extra_feeds": {}},
    {"id": "france_antilles", "name": "France Antilles", "category": "PQR", "subcategory": "Outre-mer", "url": "https://news.google.com/rss/search?q=source:martinique.franceantilles.fr&hl=fr&gl=FR&ceid=FR:fr", "interval": 60, "active": True, "tags": ["martinique", "antilles"], "extra_feeds": {}},
    ...
    {"id": "france_24_fr", "name": "France 24", "category": "TV", "subcategory": "International", "url": "https://www.france24.com/fr/rss", "interval": 15, "active": True, "tags": ["international"], "extra_feeds": {}},
    ...
    {"id": "public_senat", "name": "Public Sénat", "category": "TV", "subcategory": "Info nationale", "url": "https://www.publicsenat.fr/rss/info.xml", "interval": 15, "active": True, "tags": ["politique", "sénat"], "extra_feeds": {}},
    {"id": "lcp", "name": "LCP — Assemblée Nationale", "category": "TV", "subcategory": "Info nationale", "url": "https://www.lcp.fr/rss.xml", "interval": 15, "active": True, "tags": ["politique", "parlement"], "extra_feeds": {}},
    {"id": "bsmart", "name": "BSmart", "category": "TV", "subcategory": "Économie", "url": "https://www.bsmart.fr/rss/articles", "interval": 15, "active": True, "tags": ["économie", "business"], "extra_feeds": {}},
    {"id": "outre_mer_1ere", "name": "Outre-mer la 1ère", "category": "TV", "subcategory": "Outre-mer", "url": "https://la1ere.francetvinfo.fr/rss.xml", "interval": 30, "active": True, "tags": ["outre-mer"], "extra_feeds": {}},
    {"id": "reunion_1ere", "name": "Réunion la 1ère", "category": "TV", "subcategory": "Outre-mer", "url": "https://la1ere.francetvinfo.fr/reunion/rss.xml", "interval": 60, "active": True, "tags": ["réunion", "outre-mer"], "extra_feeds": {}},
    {"id": "guadeloupe_1ere", "name": "Guadeloupe la 1ère", "category": "TV", "subcategory": "Outre-mer", "url": "https://la1ere.francetvinfo.fr/guadeloupe/rss.xml", "interval": 60, "active": True, "tags": ["guadeloupe", "outre-mer"], "extra_feeds": {}},
    {"id": "martinique_1ere", "name": "Martinique la 1ère", "category": "TV", "subcategory": "Outre-mer", "url": "https://la1ere.francetvinfo.fr/martinique/rss.xml", "interval": 60, "active": True, "tags": ["martinique", "outre-mer"], "extra_feeds": {}},
    {"id": "guyane_1ere", "name": "Guyane la 1ère", "category": "TV", "subcategory": "Outre-mer", "url": "https://la1ere.francetvinfo.fr/guyane/rss.xml", "interval": 60, "active": True, "tags": ["guyane", "outre-mer"], "extra_feeds": {}},
    ...
    {"id": "europe_1", "name": "Europe 1", "category": "Radio", "subcategory": "Généraliste", "url": "https://www.europe1.fr/rss/france", "interval": 15, "active": True, "tags": ["généraliste"], "extra_feeds": {}},
    ...
    {"id": "rtl", "name": "RTL", "category": "Radio", "subcategory": "Généraliste", "url": "https://www.rtl.fr/actu/rss.xml", "interval": 15, "active": True, "tags": ["généraliste"], "extra_feeds": {}},
    ...
    {"id": "cour_des_comptes", "name": "Cour des comptes", "category": "Agence", "subcategory": "Institutionnel", "url": "https://www.ccomptes.fr/fr/rss.xml", "interval": 360, "active": True, "tags": ["institutionnel", "finances publiques"], "extra_feeds": {}},
    ...
    {"id": "so_foot", "name": "So Foot", "category": "Magazine", "subcategory": "Sport", "url": "https://www.sofoot.com/rss.xml", "interval": 360, "active": True, "tags": ["sport", "football"], "extra_feeds": {}},
    {"id": "rugbyrama", "name": "Rugbyrama", "category": "Magazine", "subcategory": "Sport", "url": "https://news.google.com/rss/search?q=source:rugbyrama.fr&hl=fr&gl=FR&ceid=FR:fr", "interval": 360, "active": True, "tags": ["sport", "rugby"], "extra_feeds": {}},
    {"id": "cyclismactu", "name": "Cyclismactu", "category": "Magazine", "subcategory": "Sport", "url": "https://www.cyclismactu.net/feed/", "interval": 360, "active": True, "tags": ["sport", "cyclisme"], "extra_feeds": {}},
    {"id": "premiere", "name": "Première", "category": "Magazine", "subcategory": "Culture", "url": "https://www.premiere.fr/rss/actu-cinema", "interval": 360, "active": True, "tags": ["cinéma", "culture"], "extra_feeds": {}},
    {"id": "paris_match", "name": "Paris Match", "category": "Magazine", "subcategory": "Généraliste", "url": "https://www.parismatch.com/rss/home", "interval": 360, "active": True, "tags": ["société"], "extra_feeds": {}},
    {"id": "pour_la_science", "name": "Pour la Science", "category": "Magazine", "subcategory": "Science", "url": "https://www.pourlascience.fr/rss.xml", "interval": 360, "active": True, "tags": ["science"], "extra_feeds": {}},
    {"id": "futura_sciences", "name": "Futura Sciences", "category": "Magazine", "subcategory": "Science", "url": "https://www.futura-sciences.com/rss/actualites.xml", "interval": 360, "active": True, "tags": ["science", "tech"], "extra_feeds": {}},
    {"id": "quotidien_medecin", "name": "Quotidien du Médecin", "category": "Magazine", "subcategory": "Santé", "url": "https://www.lequotidiendumedecin.fr/rss.xml", "interval": 360, "active": True, "tags": ["santé", "médecine"], "extra_feeds": {}},
    {"id": "egora", "name": "Egora", "category": "Magazine", "subcategory": "Santé", "url": "https://www.egora.fr/rss.xml", "interval": 360, "active": True, "tags": ["santé", "médecine"], "extra_feeds": {}},
