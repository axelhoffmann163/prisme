...
def bulk_insert_articles(articles):
    ...
    values = [(
        ...
        a.category, a.topic, a.tags, a.language, a.published_at,
    ) for a in articles]
    sql = """
    INSERT INTO articles (
        source_id, feed_id, content_hash, guid, url,
        title, summary, full_text, author, image_url,
        category, topic, tags, language, published_at
...
def get_recent_articles(limit=50, category=None, topic=None):
    ...
    SELECT a.id, a.title, a.url, a.summary, a.published_at, a.collected_at,
           a.author, a.tags, a.nlp_sentiment, a.category, a.topic,
